...
public class quizStudent extends javax.swing.JFrame {
    ...
    public void submit()
    {
        ...
        try{
            ...
            Statement st=con.createStatement();
            String marks1=String.valueOf(marks);
            st.executeUpdate("update student set marks='"+marks1+"' where rollNo='"+rollNo+"' ");
    ...
    private void initComponents() {
        ...
        jLabel13.setText("KhurshidaBegum");
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 110, 310, 660));

        jLabel20.setFont(new java.awt.Font("Tahoma", 1, 20)); // NOI18N
        jLabel20.setText("Question Demo?");
        getContentPane().add(jLabel20, new org.netbeans.lib.awtextra.AbsoluteConstraints(381, 168, -1, -1));
        ...
        getContentPane().add(jRadioButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(374, 306, -1, -1));
        ...
        getContentPane().add(jRadioButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(374, 396, -1, -1));
        ...
        getContentPane().add(jRadioButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(374, 479, -1, -1));
        ...
        getContentPane().add(jRadioButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(374, 558, -1, -1));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(406, 645, -1, -1));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(1209, 645, -1, -1));
